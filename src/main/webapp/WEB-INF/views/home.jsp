...
<body>
	...
	<div id="loginCadastro"> 
		<a href="inserirUsuarioFormulario" type="button" class="btn btn-success navbar-btn"> Cadastrar-se </a>
		<a href="efetuarLogin" type="button" class="btn btn-primary navbar-btn"> Logar </a>
	</div>
